...
WebUI.callTestCase(findTestCase('com.home.pages/click_on_Allow_location_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.home.pages/click_on_Allow_while_using_app'), [:], FailureHandling.STOP_ON_FAILURE)
