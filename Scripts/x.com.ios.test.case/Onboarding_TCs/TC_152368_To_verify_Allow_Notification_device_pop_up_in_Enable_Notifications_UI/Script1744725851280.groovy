...
WebUI.callTestCase(findTestCase('com.home.pages/click_on_Allow_notificaton_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.home.pages/validate_notification_popup'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.home.pages/click_Allow_in_the_Enable_Notifications_pop_up'), [:], FailureHandling.STOP_ON_FAILURE)
