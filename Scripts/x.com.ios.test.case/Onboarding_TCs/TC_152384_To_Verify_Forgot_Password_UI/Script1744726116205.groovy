...
WebUI.callTestCase(findTestCase('com.home.pages/Select_train_option'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.sign.in.pages/validate_forgot_password_screen'), [:], FailureHandling.STOP_ON_FAILURE)
