...
WebUI.callTestCase(findTestCase('com.login.page/click_on_skip_button_on_onboarding_screen'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.login.page/validate_home_screen_UI'), [:], FailureHandling.STOP_ON_FAILURE)
