...
WebUI.callTestCase(findTestCase('com.tickets.pages/validate_select_via_UI'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/click_on_back'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/validate_select_Destination_UI_text'), [:], FailureHandling.STOP_ON_FAILURE)
