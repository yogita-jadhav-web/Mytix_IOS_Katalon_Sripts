...
WebUI.callTestCase(findTestCase('com.tickets.pages/Validate_search_in_Select_Origin_UI_30TH_ST_Phila'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/Search_in_Select_Destination_UI_ANDERSON_ST'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/select_via_SECAUCUS_JCT'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/click_on_add_icon_One_way_Adult'), [:], FailureHandling.STOP_ON_FAILURE)
