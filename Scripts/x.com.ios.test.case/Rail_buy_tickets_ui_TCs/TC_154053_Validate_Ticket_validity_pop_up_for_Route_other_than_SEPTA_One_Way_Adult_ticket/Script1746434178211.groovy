...
WebUI.callTestCase(findTestCase('com.tickets.pages/Validate_search_in_Select_Origin_UI_Metropark'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.tickets.pages/Search_in_Select_Destination_UI_Metuchen'), [:], FailureHandling.STOP_ON_FAILURE)
