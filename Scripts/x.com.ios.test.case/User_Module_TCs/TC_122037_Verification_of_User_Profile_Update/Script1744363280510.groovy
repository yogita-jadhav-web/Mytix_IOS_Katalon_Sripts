...
WebUI.callTestCase(findTestCase('com.create.account.pages/click_on_submit_code_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.create.account.pages/validate_account_created_successfully_screen'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.home.pages/click_on_continue_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.user.profile.pages/update_the_user_profile'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.sign.out.pages/Sign_out_the_application'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.sign.in.pages/Enter_Sign_In_Credentials_Random_Email'), [:], FailureHandling.STOP_ON_FAILURE)
