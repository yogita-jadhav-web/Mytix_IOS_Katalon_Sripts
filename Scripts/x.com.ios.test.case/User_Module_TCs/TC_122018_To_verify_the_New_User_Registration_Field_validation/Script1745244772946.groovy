...
WebUI.callTestCase(findTestCase('com.create.account.pages/validate_create_account_screen_ui_layout'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.home.pages/click_on_submit_button'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.create.account.pages/Verify_Email_cannot_be_empty'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.create.account.pages/Email_Field_Validations'), [:], FailureHandling.STOP_ON_FAILURE)
