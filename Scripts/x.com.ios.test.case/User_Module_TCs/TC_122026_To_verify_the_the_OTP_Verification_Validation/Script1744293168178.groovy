...
WebUI.callTestCase(findTestCase('com.create.account.pages/Verify_Enter a valid security code'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.create.account.pages/Enter_less_than_six_digit_otp'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('1.com.db/Verify_the_g_users_data'), [:], FailureHandling.STOP_ON_FAILURE)
