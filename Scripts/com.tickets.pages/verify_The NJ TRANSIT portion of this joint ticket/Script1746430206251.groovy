...
String actualMessage = Mobile.getAttribute(findTestObject('IOS/Rail_Select_origin_object_repository/XCUIElementTypeStaticText - The NJ TRANSIT portion of this joint ticket will expire 30 days'), 
    'value', 10)

String expectedMessage = MessageValidator.validateMessage(15)
