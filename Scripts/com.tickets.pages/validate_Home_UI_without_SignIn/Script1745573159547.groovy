...
WebUI.callTestCase(findTestCase('com.home.pages/validate_create_an_account_link'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.tickets.pages/Validate_Tickets_section_in_home_UI'), [:], FailureHandling.STOP_ON_FAILURE)
