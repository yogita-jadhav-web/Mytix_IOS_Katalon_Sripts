...
Mobile.verifyElementExist(findTestObject('IOS/Onboarding_screen_object_repository/XCUIElementTypeImage - location_graphic'), 0)
...
WebUI.comment('Welcome_Text : ' + Welcome_Text)

Mobile.verifyElementExist(findTestObject('IOS/Onboarding_screen_object_repository/XCUIElementTypeButton - No, thanks'), 0)
