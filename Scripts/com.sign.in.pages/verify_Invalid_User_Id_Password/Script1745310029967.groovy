...
String actualMessage = Mobile.getText(findTestObject('IOS/Sign_In_object_repository/XCUIElementTypeStaticText - Invalid User IdPassword'), 
    0)

String expectedMessage = MessageValidator.validateMessage(14)
