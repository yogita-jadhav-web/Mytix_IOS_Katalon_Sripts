...
String actualMessage = Mobile.getAttribute(findTestObject('Object Repository/IOS/Create_account_object_repository/XCUIElementTypeStaticText - Account Created Successfully'), 'value', 10)

String expectedMessage = MessageValidator.validateMessage(11)
