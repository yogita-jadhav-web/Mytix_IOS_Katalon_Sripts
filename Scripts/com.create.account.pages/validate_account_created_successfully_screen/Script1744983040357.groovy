...
WebUI.callTestCase(findTestCase('com.create.account.pages/verify_Account Created Successfully'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.comment('Congratulations : ' + Congratulations_text)
