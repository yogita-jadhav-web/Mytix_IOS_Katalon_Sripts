...
String actualMessage = Mobile.getText(findTestObject('Object Repository/IOS/Create_account_object_repository/XCUIElementTypeStaticText - Password and confirm password does not match'), 
    0)

String expectedMessage = MessageValidator.validateMessage(8)
