...
String actualMessage = Mobile.getText(findTestObject('IOS/Create_account_object_repository/XCUIElementTypeStaticText - Enter a valid security code'), 
    0)

String expectedMessage = MessageValidator.validateMessage(3)
