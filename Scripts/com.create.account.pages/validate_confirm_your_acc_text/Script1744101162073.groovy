...
confirm_acc_text = Mobile.getText(findTestObject('IOS/change_password_object_repositary/XCUIElementTypeStaticText - Change Password'), 
    0)

println('Confirm Your Account : ' + confirm_acc_text)
...
WebUI.comment('security_text : ' + security_text)
