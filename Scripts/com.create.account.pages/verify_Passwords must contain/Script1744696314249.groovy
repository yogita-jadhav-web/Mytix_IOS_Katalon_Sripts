...
String actualMessage = Mobile.getAttribute(findTestObject('Object Repository/IOS/Create_account_object_repository/XCUIElementTypeStaticText - Passwords must contain'), 'value', 10)

String expectedMessage = MessageValidator.validateMessage(7)
