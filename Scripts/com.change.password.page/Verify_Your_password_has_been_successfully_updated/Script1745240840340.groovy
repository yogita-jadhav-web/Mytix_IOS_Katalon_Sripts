...
String actualMessage = Mobile.getText(findTestObject('IOS/change_password_object_repositary/XCUIElementTypeStaticText - Your password has been successfully updated'), 
    0)

String expectedMessage = MessageValidator.validateMessage(13)
