...
String actualMessage = Mobile.getText(findTestObject('IOS/change_password_object_repositary/XCUIElementTypeStaticText - Change Password Successfully'), 
    0)

String expectedMessage = MessageValidator.validateMessage(12)
