...
not_run: WebUI.callTestCase(findTestCase('com.create.account.pages/Enter_security_code_Using_Random_Email'), [:], FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.callTestCase(findTestCase('com.home.pages/click_on_continue_button'), [:], FailureHandling.STOP_ON_FAILURE)
