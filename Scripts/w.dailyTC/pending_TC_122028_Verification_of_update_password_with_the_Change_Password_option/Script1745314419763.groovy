...
WebUI.callTestCase(findTestCase('com.sign.in.pages/validate_Enter_the_email_address_text'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('com.change.password.page/Login_With_Old_Password'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('com.change.password.page/Login_With_New_Password'), [:], FailureHandling.STOP_ON_FAILURE)
