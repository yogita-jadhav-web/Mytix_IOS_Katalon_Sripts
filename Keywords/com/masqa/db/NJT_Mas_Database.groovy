...
public class NJT_Mas_Database {
	...
	public Connection get_MySQL_Mas_DBConnection(String NJT_Mas_DB_Url,String NJT_Mas_DB_UserName,String NJT_Mas_DB_Password) {
		...
		if(con==null) {
			...
			try {
				...
				//con=DriverManager.getConnection("jdbc:mysql://10.150.10.221:23306/masqa","qauser","QaU5e6cl0ud");
				...
				println("MYSQL NJT MAS Database Connection Failed ! Error: " + ex.getMessage())
				ex.printStackTrace();
			}
	...
	public String get_OTP_from_DB(Connection db_conn_obj, String email_id) {
		...
		try {
			...
			//	String sql_query="select * from masqa.p_email_message where RECIPIENTS = 'SangMuller@maildrop.cc' order by CREATED_DATE desc LIMIT 1";
		...
		String Opt1= String.format("%06d", Integer.parseInt(otp));
		System.out.println("Final OTP : " + Opt1);
